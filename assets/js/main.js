...
// Fonction pour initialiser le modal des certificats
function initCertificateModal() {
    ...
    if (!modal) return; // Quitter si le modal n'existe pas

    // Ouvrir le modal au clic sur les boutons
...
window.reInitEffects = function() {
    ...
    // Initialiser le modal des certificats
